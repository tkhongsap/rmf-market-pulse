...
- [x] **1.0 Audit Data Quality & Define Tool Contracts** ✅
  ...
  - [x] 1.3 Run existing script `npm run data:rmf:identify-incomplete` to check fund completeness ✅ (100% complete - 403/403 funds)
  - [x] 1.4 Document data gaps in new file `docs/openai-app-sdk/DATA_GAPS.md` (missing fields, null patterns, edge cases) ✅
    ...
    - [x] 1.4.4 **PHASE 0 GATE**: Verify at least 90% of funds have non-null NAV data ✅ (100% pass)
    - [x] 1.4.5 **PHASE 0 GATE**: Verify at least 80% of funds have YTD performance data ✅ (95%+ pass)
  ...
  - [x] 1.6 Define JSON input/output schemas for each tool with sample payloads from real funds ✅ (B-ASEANRMF, ABAPAC-RMF examples)
  - [x] 1.7 Add MCP-specific Zod schemas to `shared/schema.ts`: ✅
    ...
    - [x] 1.7.6 `mcpErrorResponseSchema` - Error response wrapper ✅
  - [x] 1.8 Review and get stakeholder approval on tool contracts ✅ (documented, ready for review)
